...
cprequire_test(["inline:com-chilipeppr-G2CORE_WrkSpace"], function(ws) {
...
cpdefine("inline:com-chilipeppr-G2CORE_WrkSpace", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-G2CORE_WrkSpace", // Make the id the same as the cpdefine id
        name: "Workspace / G2CORE_WrkSpace", // The descriptive name of your widget.
        desc: `1st try at workspace for G2 Core`,
