# com-chilipeppr-G2CORE_WrkSpace
1st try at workspace for G2 Core

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / G2CORE_WrkSpace
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-G2CORE_WrkSpace |
| Name                  | Workspace / G2CORE_WrkSpace |
| Description           | 1st try at workspace for G2 Core |
| chilipeppr.load() URL | http://raw.githubusercontent.com/cmaccioli/G2CORE_WrkSpace/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/cmaccioli/cp_g2core |
| Github URL            | http://github.com/cmaccioli/G2CORE_WrkSpace |
| Test URL              | https://preview.c9users.io/cmaccioli/cp_g2core/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/cmaccioli/G2CORE_WrkSpace/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-G2CORE_WrkSpace"], // the id you gave your workspace
      function(myG2CORE_WrkSpace) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / G2CORE_WrkSpace just got loaded.", myG2CORE_WrkSpace);
        myG2CORE_WrkSpace.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-G2CORE_WrkSpace"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / G2CORE_WrkSpace"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"1st try at workspace for G2 Core"</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/cmaccioli/G2CORE_WrkSpace/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/cmaccioli/cp_g2core"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/cmaccioli/G2CORE_WrkSpace"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://cp_g2core-cmaccioli.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
